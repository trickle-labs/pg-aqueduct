...
> **Status:** v0.20.0 — Executor Architecture, Multi-Tenant Catalog & CLI Polish. Typed ExecutionContext, full catalog schema parameterisation, automated compensating-step recovery, OutputEmitter singleton. See [CHANGELOG](CHANGELOG.md) for full details.
