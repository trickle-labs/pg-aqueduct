-- SEC-07: SQL grant templates for aqueduct roles.
--
-- Copy and customise these templates for your environment.  Replace
-- <schema> with each schema that contains stream tables or consumer views.
--
-- These roles follow the principle of least privilege.  Each role is scoped
-- to exactly the operations it needs to perform.
